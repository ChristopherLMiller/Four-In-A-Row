...
void D3DApp::initMainWindow()
{
	...
	// Default to a window with a client area rectangle of 1024x768.
...
LRESULT D3DApp::msgProc(UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_SIZE:
		if( gd3dDevice )
		{
			md3dPP.BackBufferWidth  = 1024;
			md3dPP.BackBufferHeight = 768;
...
void D3DApp::enableFullScreenMode(bool enable)
{
	...
	if( enable )
	{
		...
		SetWindowPos(mhMainWnd, HWND_TOP, 0, 0, 1024, 768, SWP_NOZORDER | SWP_SHOWWINDOW);	
	}
